...
import { OllamaContribution } from './ollama/ollamaConfiguration.js';
import { DarkMatterWelcomeContribution } from './ollama/darkmatterWelcome.js';
...
registerWorkbenchContribution2(OllamaContribution.ID, OllamaContribution, WorkbenchPhase.BlockRestore);
registerWorkbenchContribution2(DarkMatterWelcomeContribution.ID, DarkMatterWelcomeContribution, WorkbenchPhase.AfterRestored);
